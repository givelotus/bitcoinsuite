...
pub struct BitcoindTestInstance {
    conf: BitcoindTestConf,
...
impl BitcoindTestInstance {
    pub fn setup(conf: BitcoindTestConf) -> Result<Self> {
...
impl Drop for BitcoindTestInstance {
    fn drop(&mut self) {
